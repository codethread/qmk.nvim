local E = {
	...
	keymap_empty = function(name) return 'QMK: [E04] No keys found in keymap ' .. name end,
	...
	config_invalid_symbol = 'QMK: [E06] invalid layout, expected "x", "|" or "^"',
	...
	layout_trailing_whitespace = 'QMK: [E11] layout starts or ends with whitespace, use a break "|" or span "x^" to create spaces',
	layout_double_whitespace = 'QMK: [E12] layout contains two or more adjacent spaces, use a break "|" or span "x^" to create spaces',
